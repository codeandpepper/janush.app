...
export class JanushAutoGeneratedAppCiStack extends Stack {
  constructor(
    scope: Construct,
    id: string,
    ...
    const amplifyApp = new amplify.App(
      this,
      `${envName}JanushAutoGeneratedApp`,
      {
        appName: `${envName}-janush-auto-generated-app-amplify-hosting`,
      }
    );
    ...
    const bucket = new s3.Bucket(
      this,
      `${envName}-janush-auto-generated-app-ci-bucket`,
      {
    ...
    new CfnOutput(this, "S3BucketNameExport", {
      exportName: "s3BucketNameJanushAutoGeneratedApp",
